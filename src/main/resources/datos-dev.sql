...
INSERT INTO recetas (id , nombre , ingredientes, favorita, usuario_id, compartida) VALUES ('1' , 'Receta 1 favorita no compartida'    , 'Ingredientes 1' , true ,   '1' , false);
INSERT INTO recetas (id , nombre , ingredientes, favorita, usuario_id, compartida) VALUES ('2' , 'Receta 1 favorita compartida'       , 'Ingredientes 1' , true ,   '1' , true );
